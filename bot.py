...
async def get_weather_forecast():
    ...
    try:
        prompt = "Дай практичну пораду птахівникам на завтрашню погоду. Максимум 200-300 символів. Додай цікавий факт про чи про бройлерів чи про качок, індиків, перепілок, гусей ."
