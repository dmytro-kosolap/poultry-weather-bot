...
async def get_weather_forecast():
    ...
    # Порада з елементом цікавого факту
    try:
        prompt = "Дай практичну пораду птахівникам на завтрашню погоду. Максимум 200-300 символів. Додай цікавий факт чи то про бройлерів чи про качок, індиків, перепілок, гусей. Вибери сам."
